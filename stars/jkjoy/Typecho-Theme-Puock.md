...
- 2025.10.15  v1.2.4
    ...
    - 修复文章内嵌短代码解析问题，确保所有短代码均能正确渲染
    - 优化短代码解析逻辑，提升解析效率和稳定性
    - 增强与 Typecho 1.3.0 版本的兼容性，确保主题功能正常运行

- 2025.10.17 v1.2.5

    - 升级插件兼容Typecho 1.3.0版本并整合友情链接功能 
