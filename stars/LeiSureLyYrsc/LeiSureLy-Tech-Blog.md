---
project: LeiSureLy-Tech-Blog
stars: 1
description: |-
    一个特别棒的VitePress博客主题！创作者为Clark Cui
url: https://github.com/LeiSureLyYrsc/LeiSureLy-Tech-Blog
---
...
```shell
npx degit -cui/vitepress-blog-zaun my-vitepress-blog
